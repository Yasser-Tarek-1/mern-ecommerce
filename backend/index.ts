...
import { CONNECTION_DB } from "./src/db/Connection_DB";
import productsRoutes from "./src/router/product.router";
import cartRoutes from "./src/router/cart.router";
import userRoutes from "./src/router/user.router";
import favouritesRoute from "./src/router/favourite.router";
import showImagesRoute from "./src/router/img.router";
import cors from "cors";
import { uploadingMiddleware } from "./src/middleware/upload.middleware";
import { uploading } from "./src/helpers/uploading";
const app = express();
